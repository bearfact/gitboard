class ChangeWebhookEvent
    ...
    def save
        ...
        if !self.hook_id
            res = github.repos.hooks.create self.owner, self.repo, name: "web", active: true, config: {url: 'https://gitboard.io/issueshook', content_type: 'json', secret: '', insecure_ssl: 0, ssl_version: 3}, events: ['issues']
        else
